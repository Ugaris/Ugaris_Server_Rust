...
use ugaris_core::{
    ...
    character_driver::{
        needs_next_lab, CharacterDriverState, CDR_ASTURIN, CDR_BIGBADSPIDER, CDR_BREDEL,
        CDR_CALIGARSKELLY, CDR_CAMERON_FORESTMONSTER, CDR_DUNGEONMASTER, CDR_GATE_FIGHT,
        CDR_GATE_WELCOME, CDR_LAB2UNDEAD, CDR_LOSTCON, CDR_LQNPC, CDR_MERCHANT, CDR_PALACEISLENA,
        CDR_RIVERBEAST, CDR_SIMPLEBADDY, CDR_SWAMPMONSTER, CDR_TEUFELRAT, NTID_GATEKEEPER, NT_NPC,
    },
