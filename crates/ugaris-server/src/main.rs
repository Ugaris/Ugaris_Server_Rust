    ...
    loop {
        tokio::select! {
            _ = tick.tick() => {
                ...
                let ac_warn_events_applied =
                    apply_ac_warn_events(&mut world, &anticheat_repository).await;
                ...
                let ac_sigadd_events_applied =
                    apply_ac_sigadd_events(&mut world, &anticheat_repository).await;
                ...
                let ac_sigdel_events_applied =
                    apply_ac_sigdel_events(&mut world, &anticheat_repository).await;
