...
pub(crate) use area29::*;
pub(crate) use area3::*;
pub(crate) use area31::*;
pub(crate) use area32::*;
pub(crate) use area33::*;
pub(crate) use area34::*;
pub(crate) use area36::*;
pub(crate) use area37::*;
...
use ugaris_core::{
    ...
    character_driver::{
        needs_next_lab, CharacterDriverState, GolemKeyholdDriverData, CDR_ASTRO1, CDR_ASTRO2,
        CDR_ASTURIN, CDR_BIGBADSPIDER, CDR_BREDEL, CDR_BRITHILDIE, CDR_CALIGARSKELLY,
        CDR_CAMERON_FORESTMONSTER, CDR_CAMHERMIT, CDR_CARLOS, CDR_DUNGEONMASTER, CDR_FORESTMONSTER,
        CDR_GATE_FIGHT, CDR_GATE_WELCOME, CDR_GREETER, CDR_GUIWYNN, CDR_JAMES, CDR_JESSICA,
        CDR_KASSIM, CDR_KELLY, CDR_LAB2UNDEAD, CDR_LAMPGHOST, CDR_LOGAIN, CDR_LOSTCON, CDR_LQNPC,
        CDR_LYDIA, CDR_MERCHANT, CDR_NOOK, CDR_PALACEISLENA, CDR_RIVERBEAST, CDR_SEYMOUR,
        CDR_SIMPLEBADDY, CDR_SIRJONES, CDR_SUPERMAX, CDR_SWAMPMONSTER, CDR_TERION, CDR_TEUFELRAT,
        CDR_THOMAS, CDR_VAMPIRE, CDR_VAMPIRE2, NTID_GATEKEEPER, NT_NPC,
    },
    ...
    item_driver::{
        bare_value, legacy_lucky_die_from_rolls, lower_value, skillmax, ForestSpadeFind,
        IDR_ACCOUNT_DEPOT, IDR_ARKHATA, IDR_BOOKCASE, IDR_DECAYITEM, IDR_DEMONCHIP,
        IDR_DEMONSHRINE, IDR_ENHANCE, IDR_FOOD, IDR_ISLENADOOR, IDR_KEY_RING, IDR_LAB2_GRAVE,
        IDR_MELTINGKEY, IDR_PICKCHEST, IDR_PICKDOOR, IDR_RATCHEST, IDR_SPECIAL_POTION, IDR_TORCH,
