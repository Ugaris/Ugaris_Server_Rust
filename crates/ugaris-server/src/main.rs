...
use ugaris_core::{
    ...
    character_driver::{
        ...
        CDR_LOGAIN, CDR_LOSTCON, CDR_LQNPC, CDR_LYDIA, CDR_MERCHANT, CDR_NOOK, CDR_PALACEISLENA,
        CDR_RIVERBEAST, CDR_SEYMOUR, CDR_SIMPLEBADDY, CDR_SIRJONES, CDR_SUPERMAX, CDR_SWAMPMONSTER,
        CDR_TERION, CDR_TEUFELRAT, CDR_THOMAS, CDR_VAMPIRE, CDR_VAMPIRE2, NTID_GATEKEEPER, NT_NPC,
    },
