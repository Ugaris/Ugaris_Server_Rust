...
use ugaris_core::{
    ...
    character_driver::{
        ...
        CDR_LYDIA, CDR_MERCHANT, CDR_NOOK, CDR_PALACEISLENA, CDR_RIVERBEAST, CDR_SIMPLEBADDY,
        CDR_SIRJONES, CDR_SWAMPMONSTER, CDR_TERION, CDR_TEUFELRAT, CDR_THOMAS, CDR_VAMPIRE,
