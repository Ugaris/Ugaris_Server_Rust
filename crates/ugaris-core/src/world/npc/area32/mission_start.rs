...
pub struct MissionFighterData {
    ...
    /// C `char *itemtemp` (`missions.c:464`): the reward chest's item
    /// template name, or `None` for the three templates with no
    /// find-item objective (`missionchest_driver`'s "The chest is empty."
    /// branch).
    pub itemtemp: Option<&'static str>,
    pub itemname: Option<&'static str>,
    /// C `char *itemdesc` (`missions.c:466`).
    pub itemdesc: Option<&'static str>,
    pub area: u16,
...
pub const MISSION_FIGHTER_DATA: [MissionFighterData; 7] = [
    MissionFighterData {
        ...
        temp: "mis_warrior",
        bosstemp: "mis_seyan",
        itemtemp: Some("mis_documents"),
        itemname: Some("Documents"),
        itemdesc: Some("The stolen documents."),
        area: 0,
    ...
    MissionFighterData {
        ...
        temp: "mis_warrior",
        bosstemp: "mis_seyan",
        itemtemp: Some("mis_book"),
        itemname: Some("Book"),
        itemdesc: Some("The stolen book."),
        area: 1,
        char_flags: CharacterFlags::ALIVE,
    },
    MissionFighterData {
    ...
    MissionFighterData {
        ...
        itemtemp: Some("mis_spoon"),
        itemname: Some("Spoon of Doom"),
        itemdesc: Some("The magical spoon of doom. Even Gwendylon has heard about it."),
        area: 4,
        char_flags: CharacterFlags::UNDEAD,
    },
    MissionFighterData {
        ...
        temp: "mis_warrior",
        bosstemp: "mis_warrior",
        itemtemp: Some("mis_ring"),
        itemname: Some("Ring"),
        itemdesc: Some("A simple, silver ring. The object of 'The Bet'."),
        area: 5,
        char_flags: CharacterFlags::UNDEAD,
    },
];
