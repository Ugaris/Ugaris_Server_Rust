use super::*;
use crate::character_driver::CDR_MILITARY_MASTER;
...
pub(super) fn demon_mission(pts: i32, exp: i32) -> SingleMission {
    SingleMission {
...
//-----------------------
// Shared fixtures for the sibling military_* test files.

pub(super) fn master_npc(id: u32) -> Character {
...
pub(super) fn recruit(id: u32) -> Character {
