...
use crate::{
    ...
    character_driver::{
        ...
        CDR_DUNGEONFIGHTER, CDR_FORESTMONSTER, CDR_GATE_WELCOME, CDR_LOSTCON, CDR_MERCHANT,
        CDR_MISSIONFIGHT, CDR_PENTER, CDR_SIMPLEBADDY, CDR_SMUGGLELEAD, CDR_SWAMPMONSTER,
        CDR_TEUFELDEMON, CDR_TEUFELRAT, CDR_TWOROBBER, CDR_WHITEROBBERBOSS, FDEMON_MSG_WAYPOINT,
