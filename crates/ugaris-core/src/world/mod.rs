...
use crate::{
    ...
    character_driver::{
        ...
        CDR_ACLERK, CDR_BANK, CDR_DUNGEONFIGHTER, CDR_GATE_FIGHT, CDR_GATE_WELCOME, CDR_JANITOR,
        CDR_LAB2UNDEAD, CDR_LOSTCON, CDR_MERCHANT, CDR_MILITARY_ADVISOR, CDR_MILITARY_MASTER,
