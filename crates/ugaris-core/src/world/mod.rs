...
use crate::{
    ...
    character_driver::{
        ...
        CDR_FORESTMONSTER, CDR_GATE_WELCOME, CDR_LOSTCON, CDR_MERCHANT, CDR_PENTER,
        CDR_SIMPLEBADDY, CDR_SWAMPMONSTER, CDR_TWOROBBER, FDEMON_MSG_WAYPOINT, NTID_FDEMON,
    ...
    item_driver::{
        ...
        IDR_DUNGEONDOOR, IDR_EDEMONBALL, IDR_EDEMONBLOCK, IDR_EDEMONDOOR, IDR_EDEMONGATE,
        IDR_EDEMONLIGHT, IDR_EDEMONLOADER, IDR_EDEMONSWITCH, IDR_EDEMONTUBE, IDR_FDEMONCANNON,
        IDR_FDEMONFARM, IDR_FDEMONGATE, IDR_FDEMONLIGHT, IDR_FDEMONLOADER, IDR_FLAMETHROW,
        IDR_FLASK, IDR_FORESTCHEST, IDR_LAB2_WATER, IDR_LAB3_PLANT, IDR_LABTORCH, IDR_MINEDOOR,
