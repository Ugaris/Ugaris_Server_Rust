...
use crate::{
    ...
    character_driver::{
        ...
        SimpleBaddyMessageOutcome, CDR_ACLERK, CDR_CALIGARGUARD2, CDR_CALIGARSKELLY,
        CDR_CAMERON_FORESTMONSTER, CDR_CENTINEL, CDR_DUNGEONFIGHTER, CDR_FORESTMONSTER,
        CDR_GATE_WELCOME, CDR_LOSTCON, CDR_MERCHANT, CDR_MISSIONFIGHT, CDR_PENTER, CDR_SIMPLEBADDY,
