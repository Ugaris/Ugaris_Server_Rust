...
use crate::{
    ...
    character_driver::{
        ...
        CDR_MERCHANT, CDR_MISSIONFIGHT, CDR_PENTER, CDR_SIMPLEBADDY, CDR_SMUGGLELEAD,
        CDR_SWAMPMONSTER, CDR_TEUFELDEMON, CDR_TEUFELRAT, CDR_TWOROBBER, CDR_WHITEROBBERBOSS,
