...
use crate::{
    ...
    character_driver::{
        ...
        SimpleBaddyMessageOutcome, CDR_ACLERK, CDR_ARKHATAPRISON, CDR_ARKHATASKELLY, CDR_BOOKEATER,
        CDR_CALIGARGUARD2, CDR_CALIGARSKELLY, CDR_CAMERON_FORESTMONSTER, CDR_CENTINEL,
        CDR_DUNGEONFIGHTER, CDR_FORESTMONSTER, CDR_FORTRESSGUARD, CDR_GATE_WELCOME, CDR_LOSTCON,
        CDR_MERCHANT, CDR_MISSIONFIGHT, CDR_PENTER, CDR_SHR_WEREWOLF, CDR_SIMPLEBADDY,
        CDR_SMUGGLELEAD, CDR_SWAMPMONSTER, CDR_TEUFELDEMON, CDR_TEUFELRAT, CDR_TWOROBBER,
        CDR_WHITEROBBERBOSS, FDEMON_MSG_WAYPOINT, NTID_FDEMON, NTID_LAB2_DEAMONCHECK,
    ...
    item_driver::{
        ...
        IDR_RECALL, IDR_SHRIKE, IDR_STEPTRAP, IDR_STR_DEPOT, IDR_STR_MINE, IDR_STR_SPAWNER,
        IDR_STR_STORAGE, IDR_STR_TICKER, IDR_SWAMPARM, IDR_SWAMPSPAWN, IDR_SWAMPWHISP, IDR_TORCH,
        IDR_TOYLIGHT, IDR_TUNNELDOOR2, IDR_WARPKEYDOOR, IDR_WARPTELEPORT, IDR_WARPTRIALDOOR,
