...
use crate::{
    character_driver::{
        ...
        KellyDriverData, LostDwarfDriverData, NookDriverData, ReskinDriverData, RouvenDriverData,
        ...
        CDR_LAB5MAGE, CDR_LAB5SEYAN, CDR_LABGNOMEDRIVER, CDR_LOSTDWARF, CDR_NOOK, CDR_RESKIN,
        CDR_ROUVEN, CDR_SEYMOUR, CDR_SHANRA, CDR_SIMPLEBADDY, CDR_SIRJONES, CDR_SMUGGLECOM,
