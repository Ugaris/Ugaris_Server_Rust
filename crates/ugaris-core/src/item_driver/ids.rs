...
pub(crate) const IID_ARKHATA_SCROLL1: u32 = make_item_id(DEV_ID_DB, 0x0000C2);

pub(crate) const IID_ARKHATA_AKEY1: u32 = make_item_id(DEV_ID_DB, 0x0000CA);

pub(crate) const IID_ARKHATA_AKEY2: u32 = make_item_id(DEV_ID_DB, 0x0000CB);

pub(crate) const IID_ARKHATA_AKEY3: u32 = make_item_id(DEV_ID_DB, 0x0000CC);

pub(crate) const IID_ARKHATA_AKEY12: u32 = make_item_id(DEV_ID_DB, 0x0000CD);

pub(crate) const IID_ARKHATA_AKEY23: u32 = make_item_id(DEV_ID_DB, 0x0000CE);
...
pub(crate) const IID_STAFF_BLUEKEY3: u32 = make_item_id(DEV_ID_WARR, 0x00000C);

pub(crate) const IID_STAFF_BLUEKEY12: u32 = make_item_id(DEV_ID_WARR, 0x00000D);

pub(crate) const IID_STAFF_BLUEKEY13: u32 = make_item_id(DEV_ID_WARR, 0x00000E);

pub(crate) const IID_STAFF_BLUEKEY23: u32 = make_item_id(DEV_ID_WARR, 0x00000F);

pub(crate) const IID_STAFF_GREENKEY1: u32 = make_item_id(DEV_ID_WARR, 0x000011);

pub(crate) const IID_STAFF_GREENKEY2: u32 = make_item_id(DEV_ID_WARR, 0x000012);

pub(crate) const IID_STAFF_GREENKEY3: u32 = make_item_id(DEV_ID_WARR, 0x000013);

pub(crate) const IID_STAFF_GREENKEY12: u32 = make_item_id(DEV_ID_WARR, 0x000014);

pub(crate) const IID_STAFF_GREENKEY13: u32 = make_item_id(DEV_ID_WARR, 0x000015);

pub(crate) const IID_STAFF_GREENKEY23: u32 = make_item_id(DEV_ID_WARR, 0x000016);

pub(crate) const IID_STAFF_REDKEY1: u32 = make_item_id(DEV_ID_WARR, 0x000018);

pub(crate) const IID_STAFF_REDKEY2: u32 = make_item_id(DEV_ID_WARR, 0x000019);

pub(crate) const IID_STAFF_REDKEY3: u32 = make_item_id(DEV_ID_WARR, 0x00001A);

pub(crate) const IID_STAFF_REDKEY12: u32 = make_item_id(DEV_ID_WARR, 0x00001B);
